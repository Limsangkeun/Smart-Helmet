...
public class SecondFragment extends android.support.v4.app.Fragment implements CustomDialog.uploadDialogInterface{
    ...
    private void init_tables() {
        dateSQLite = new DateSQLite(this.getActivity());
        db = dateSQLite.getReadableDatabase();
    }
    ...
    private void removeTable() {
        String removeTbl = "DROP TABLE CONTACT_T";
